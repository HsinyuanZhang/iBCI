#!/usr/bin/env python3
"""Versioned production evaluator and opaque-payload committer for Phase-C."""
...
WORKERS = {
    "spint": ROOT / "SPINT-main/src/evaluate_post33_phase_c_v4.py",
    "t4": ROOT / "streaming_calibration_exp/src/evaluate_post33_phase_c_v4.py",
}
