#!/usr/bin/env python3
"""r8 production evaluator bound only to the full repaired v5 workers."""
...
WORKERS = {
    "spint": ROOT / "SPINT-main/src/evaluate_post33_phase_c_v5_r8.py",
    "t4": ROOT / "streaming_calibration_exp/src/evaluate_post33_phase_c_v5_r8.py",
}
