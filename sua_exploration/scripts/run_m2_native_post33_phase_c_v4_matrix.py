#!/usr/bin/env python3
"""Deterministic paired multi-host-capable Phase-C matrix launcher."""
...
PIPELINE = ROOT / "sua_exploration/scripts/run_m2_native_post33_phase_c_v4_cell_pipeline.py"
...
def main() -> None:
    ...
    portable = validate_portable_transfer_manifest(
    ...
    dry = {
        "schema": "m2_post33_phase_c_shard_dry_run_v4",
    ...
    if authorization["stage"] == "stage_b":
        validate_stage_a_decision(args.cell_root, require_continue=True)
    claim_authorization_nonce(
        root=args.cell_root,
