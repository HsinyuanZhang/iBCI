#!/usr/bin/env python3
"""Exact selected-checkpoint T4 outer evaluator worker for Phase-C."""
...
def main() -> None:
    ...
    try:
        ...
        # ``Trainer.test`` returns.  Keep the post-score deployment benchmark
        # in the same deterministic inference mode as the endpoint test.
        model.eval()
