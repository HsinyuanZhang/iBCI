"""Fold-local receipts. Sealed FAIL and rSyn3 V1 PASS roots cannot be reserved."""
...
def refuse_sealed_roots(path: Path | str) -> None:
    ...
    if "m1_emg_rsyn3_fcm_v1" in text:
        raise ReceiptError("refusing sealed rsyn3_fcm_v1 root")
