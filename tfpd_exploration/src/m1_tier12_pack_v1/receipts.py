"""Immutable receipt roots for the Tier 1/2 pack cell.

Thin ImmutableArtifactRoot wrapper in the rSyn3 fold-local style. Refuses to
write into sealed T0/C1 / CS-WG / rSyn3 result roots.
"""
...
def run_stage0(
    ...
    *,
    ...
    try:
        ...
        failure_payload = {
            "schema": "m1_tier12_pack_failure_v1",
            "status": "FAILED",
