"""Self-contained Falcon runtime for H1 proj_add + exact-E.

Identity: tokens = token_mlp([local16 + P(E0)] | carrier4), token_in=20,
P = Linear(700->16, bias=False). Exact-E is causal-k5 frontend reuse plus
last-layer last-query. Window comes from the payload (200 or 250).
Does not import tfpd_exploration. Not SPINT.
"""
