#!/usr/bin/env python3
"""Local contract validation + reference scoring for the D-opt-4 activity-30 M2 image.
...
2. ``external``  - replay the LOCAL continual evaluator semantics
                   ...
                   and compare with the sealed activity30_m4 screen rows
        ...
        for surface_name, dataset, expected_count in surfaces:
            ...
            for session in sessions:
                ...
                require(
                    ...
                    f"{session} ({surface_name}) r2 drift vs sealed activity30_m4: "
            ...
            sealed_values = np.asarray(
                [row["sealed_screen_activity30_m4_r2"] for row in per_session.values()]
            )
...
def main() -> None:
    ...
    if not args.execute:
        print(json.dumps({
            "schema": "m2_dopt4_act30_local_validation_dry_v1",
    ...
    receipt: dict[str, Any] = {
        "schema_version": "m2_dopt4_act30_local_validation_v1",
