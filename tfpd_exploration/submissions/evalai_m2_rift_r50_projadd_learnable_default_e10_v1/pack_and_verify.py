...
RUN = ROOT / "btransform_unified_v2/learnable_recency_v1/results/m2_projadd_learned_slope_default_s42"
CKPT = RUN / "epoch_010.pt"
CKPT_SHA = "18e41feb9bbcdaf17183e168cf1095fc1283c08ebf5c88d1e73576d092132eb1"
SCORE = ROOT / "btransform_unified_v2/learnable_recency_v1/results/selection_m2_projadd_learned_slope_default_ext6_s42/score_receipt.json"
...
IMAGE_TAG = "m2-rift-r50-projadd-learnable-default-e10:v1"
METHOD_LABEL = (
    "M2 RIFT R50 proj_add P16 learned_slope default-ladder e10 EMA cached CPU; "
...
METHOD_NAME = "M2 RIFT R50 proj_add learned default e10"
N_STEPS = 80
GATE = 1.0e-5
...
def _build_payload() -> tuple[Path, str, dict]:
    ...
    if abs(float(selected["equal_session_mean"]) - 0.3633777147177248) > 1.0e-12:
    ...
    dest = DEST / "artifacts" / "m2_rift_r50_projadd_learnable_default_e10.pkl"
...
def main() -> int:
    ...
    candidate = {
        "arm": "m2_rift_r50_projadd_learnable_default_e10_cached",
        "budget_disclosure": (
        ...
        "method_description": (
            ...
            f"Same official 13-tag banks as 582047. ext6 pick e10 mean {selection['equal_session_mean']:.6f}. "
