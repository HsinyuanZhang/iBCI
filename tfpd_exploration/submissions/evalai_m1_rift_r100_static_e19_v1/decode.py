"""EvalAI entry for M1 RIFT R100 static_identity learned_slope e19 cached CPU."""
import argparse
import os
import sys
...
from m1_rift_falcon_decoder import M1RiftCachedFalconDecoder
...
def main() -> None:
    ...
    decoder = M1RiftCachedFalconDecoder(
        task_config=config,
