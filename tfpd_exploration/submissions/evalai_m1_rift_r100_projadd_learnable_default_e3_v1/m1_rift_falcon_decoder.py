"""Falcon runtime for M1 RIFT R100 proj_add P16 + per-layer learned_slope.
...
cached PyTorch FP32 via CpuLearnableRecencyRuntime.
"""
...
PAYLOAD_SCHEMA = "m1_rift_r100_projadd_learnable_default_e3_cached_v1"
CHANNELS = 64
BEHAVIOR_SCALE = 1.0
...
def build_decoder(recency_cfg: LearnableRecencyConfig) -> RiftDecoder:
    ...
    model = RiftDecoder("m1", context_bins=CONTEXT_BINS, bias_mode="recency", seed=SEED, proj_dim=PROJ_DIM)
...
def _task_bank(tag: str, row: dict) -> TaskBank:
    ...
    return TaskBank(
        ...
        calibration_meta={
            ...
            "trial_count": 10,
            "estimator": "official M1 7-tag native E0 + MOVE-T4 (sealed banks)",
