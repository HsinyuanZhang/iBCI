...
- image: `m2-rift-activity-only-r50-e9:v1`
- image ID: `sha256:9e0187c4eb02e777e18245a241ab2c28bd6f2eea684b3a1e17b5c5769fe5fcf4`
- payload SHA-256: `d9e4041c5f20ed63370e170ee529680db69216ccf64eb591aa42d208d6f6e3f3`
- selected epoch: 9; local EXT6 equal-session mean `0.18402467250439059` (not official)

Read-only preflight (no push/register):

```bash
/usr/bin/python3 tfpd_exploration/submissions/evalai_m2_rift_activity_only_r50_v1/submit.py
```
...
/usr/bin/python3 tfpd_exploration/submissions/evalai_m2_rift_activity_only_r50_v1/submit.py \
  --execute \
  --confirm-image-id sha256:9e0187c4eb02e777e18245a241ab2c28bd6f2eea684b3a1e17b5c5769fe5fcf4 \
  --confirm-payload-sha256 d9e4041c5f20ed63370e170ee529680db69216ccf64eb591aa42d208d6f6e3f3
```
