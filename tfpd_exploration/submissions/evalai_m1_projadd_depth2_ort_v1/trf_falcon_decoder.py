"""Self-contained Falcon runtime for M1 proj_add P16 depth-2 + exact-E.

Identity: tokens = token_mlp([local16 + P(E0)] | carrier4), token_in=20,
P = Linear(100->16, bias=False). Temporal stack is CausalPE depth-2
(2 layers, not the public default 4). Exact-E is causal-k5 frontend reuse
plus last-layer last-query. Official uint8/float bins are coerced to
C-contiguous float32. Does not import tfpd_exploration.
"""
