#!/usr/bin/env python3
"""Guarded EvalAI push/register for the packed M1 proj_add P16 exact-E image.
...
def preflight(candidate: dict[str, Any]) -> tuple[Any, Any, dict[str, Any], dict[str, Any], tuple[Any, Any, Any, str, str]]:
    ...
    expected = {
        ...
        "ai.eval.torch_threads": "2",
        "ai.eval.label_budget": "10",
    }
...
def _register(candidate: dict[str, Any], state: dict[str, object], runtime: tuple[Any, Any, Any, str, str]) -> dict[str, object]:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="m1_projadd_evalai_") as tmp:
