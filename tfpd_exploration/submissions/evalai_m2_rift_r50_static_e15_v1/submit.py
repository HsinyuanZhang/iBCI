#!/usr/bin/env python3
"""Guarded EvalAI push/register for M2 RIFT R50 static_identity e15. Do not run unless 582318 and 582319 have official scores.
...
def _push_image(candidate: dict[str, Any], client: Any, image: Any, runtime: tuple[Any, Any, Any, str, str]) -> dict[str, object]:
    ...
    state = {
        "schema_version": "m2_rift_static_evalai_push_state",
        "arm": candidate["arm"],
...
def _register(candidate: dict[str, Any], state: dict[str, object], runtime: tuple[Any, Any, Any, str, str]) -> dict[str, object]:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="m2_rift_static_evalai_") as tmp:
