"""Self-contained Falcon runtime for the M2 SMALL exact-E pick.

Same sealed SMALL EMA e19 weights and 13-tag banks as the naive full-window
image. This copy adds equivalent inference only: causal-k5 frontend reuse
and last-layer last-query evaluation. Temporal layers 1-3 stay full. No
cross-window temporal KV reuse. Does not import tfpd_exploration or
instantiate T4CachedIdentityDecoder.
"""
