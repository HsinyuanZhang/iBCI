"""Falcon runtime for H1 RIFT R300 P32 + per-layer learned_slope on default ladder.

Architecture is RIFT, recency is per-layer learned_slope on the unscaled
(default) half-life ladder. Backend is cached PyTorch FP32 via
CpuLearnableRecencyRuntime. Not BT-EORT, not ORT, not SPINT, not 582241, not 582196.
"""
...
PAYLOAD_SCHEMA = "h1_rift_r300_learnable_default_p32_e15_falcon_payload_v1"
CHANNELS = 176
BEHAVIOR_SCALE = 20.0
