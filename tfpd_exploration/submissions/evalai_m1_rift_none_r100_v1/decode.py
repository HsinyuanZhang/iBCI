"""EvalAI entry for the sealed M1 RIFT NONE CPU payload."""
...
from m1_rift_none_falcon_decoder import M1RiftNoneCachedFalconDecoder
def main():
 ...
 evaluator.evaluate(M1RiftNoneCachedFalconDecoder(FalconConfig(task=FalconTask.m1),a.model_path,a.batch_size),phase=a.phase)
