"""Falcon runtime for M2 RIFT R50 concat-side E0 + proj_add P16 learned_slope.

E0 is calibrated by ConcatSideTrunk; inference still uses stock proj_add
fusion. Recency is per-layer learned_slope on the default ladder.
"""
