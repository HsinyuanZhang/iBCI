#!/usr/bin/env python3
"""Build the H1 RIFT R300 learned_slope default e16 cached payload, host-verify, and docker-pack.
...
CKPT = ROOT / "btransform_unified_v2/learnable_recency_v1/results/h1_learned_slope_default_s42/epoch_016.pt"
CKPT_SHA = "1c73ce1089316eee317736f99efdc865e5806cd0c6cd72b16441df47f88b7948"
SCORE = ROOT / "btransform_unified_v2/learnable_recency_v1/results/h1_learned_slope_default_s42/ho_m3_selection.json"
RUN_META = ROOT / "btransform_unified_v2/learnable_recency_v1/results/h1_learned_slope_default_s42/run_meta.json"
...
IMAGE_TAG = "h1-rift-r300-learned-slope-default-e16:v1"
METHOD_LABEL = (
    "H1 RIFT R300 learned_slope default-ladder e16 EMA cached CPU; architecture=RIFT backend=cached "
    "identity=signed_state14 recency=learned_slope_default; not BT-EORT; not ORT; not SPINT; not 582196"
)
METHOD_NAME = "H1 RIFT R300 learned_slope default e16 cached"
METHOD_DESCRIPTION = (
    "H1 RIFT R300 with per-layer learned_slope on default unscaled half-life ladder, epoch 16 EMA. "
    "HO-M3 grouped-seven pick e16 r2_mean 0.4624 worst 0.2565. Cached PyTorch FP32 CPU backend. "
...
def _build_payload() -> tuple[Path, str, dict]:
    ...
    if sha256(CKPT) != CKPT_SHA:
        raise RuntimeError(f"epoch_016.pt SHA drift: {sha256(CKPT)} != {CKPT_SHA}")
    ...
    dest = DEST / "artifacts" / "h1_rift_r300_learned_slope_default_e16.pkl"
...
"""
    ...
    candidate = {
        "arm": "h1_rift_r300_learned_slope_default_e16_cached",
        "task": "h1",
        "image_tag": IMAGE_TAG,
        "image_id": image_id,
