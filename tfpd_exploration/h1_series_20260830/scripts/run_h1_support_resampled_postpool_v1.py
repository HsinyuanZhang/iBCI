#!/usr/bin/env python3
"""Run the H1 LP-F3/LP-R3/SRPD source-only five-fold screen on GPU0."""
...
from h1_support_resampled_postpool_v1.plan import (
    EXPECTED_GPU0_UUID,
    NEGATIVE_PREDECESSOR_TERMINAL_SHA256,
    SCHEMA,
)


RESULT_ROOT = REPO_ROOT / "tfpd_exploration/h1_series_20260830/results/h1_support_resampled_postpool_v1"
PREDECESSOR = REPO_ROOT / "tfpd_exploration/h1_series_20260830/results/h1_m3_cross_record_joint_postpool_v1/terminal.json"
DESIGN = REPO_ROOT / "tfpd_exploration/h1_series_20260830/docs/DESIGN_H1_SUPPORT_RESAMPLED_POSTPOOL_V1_20260903.md"
WORKORDER = REPO_ROOT / "tfpd_exploration/h1_series_20260830/docs/WORKORDER_H1_SUPPORT_RESAMPLED_POSTPOOL_V1_20260903.md"
...
def _preflight() -> dict[str, str]:
    ...
    _require(_sha256(PREDECESSOR) == NEGATIVE_PREDECESSOR_TERMINAL_SHA256, "negative predecessor terminal drift")
    ...
    return {
        ...
        "negative_predecessor_terminal_sha256": NEGATIVE_PREDECESSOR_TERMINAL_SHA256,
    }
...
def main() -> int:
    ...
    attempt_sha = _publish(RESULT_ROOT / "attempt.json", {
        ...
        "status": "ATTEMPT_GPU0_SOURCE_ONLY_BRANCH_TRAINING",
        **authority,
    ...
    try:
        from h1_support_resampled_postpool_v1.evaluate import run
