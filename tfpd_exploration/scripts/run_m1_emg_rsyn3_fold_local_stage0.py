#!/usr/bin/env python3
"""Public Stage-0 CLI for fold-local EMG-rSyn3. Default is dry. --execute is CPU only."""
...
def _dry() -> dict[str, object]:
    ...
    payload["cli"] = "run_m1_emg_rsyn3_fold_local_stage0.py"
    return payload
...
def main(argv: list[str] | None = None) -> int:
    ...
    if arguments.execute:
        ...
        from tfpd_exploration.src.m1_emg_rsyn3_fold_local_v1.stage0 import publish_stage0
