#!/usr/bin/env python3
"""Public Stage-0 CLI for EMG-rSyn3. Default is dry. --execute runs CPU Stage 0 only."""
...
def _dry() -> dict[str, object]:
    from tfpd_exploration.src.m1_emg_rsyn3_fcm_v1.plan import dry_cli_payload
    payload = dry_cli_payload()
    payload["cli"] = "run_m1_emg_rsyn3_stage0.py"
    return payload
...
def main(argv: list[str] | None = None) -> int:
    ...
    if arguments.execute:
        ...
        from tfpd_exploration.src.m1_emg_rsyn3_fcm_v1.stage0 import publish_stage0
