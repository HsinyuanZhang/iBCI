#!/usr/bin/env python3
"""Run the V6 parity-only diagnostic successor."""
...
def main() -> int:
    ...
    if not args.execute:
        print(json.dumps({
            "schema": "budget_matched_posterior_cal_aug_c2_c3_gpu_parity_diagnostic_v6_plan",
    ...
    print(json.dumps(v6.execute_reviewed(ROOT), sort_keys=True, indent=2))
    return 0
