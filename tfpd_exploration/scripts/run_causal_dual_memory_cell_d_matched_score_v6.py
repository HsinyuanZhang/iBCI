#!/usr/bin/env python3
"""Static public dry entry point for the CDM-D V6 matched-score successor.

This public surface deliberately has no capability construction path.  It
does not import Torch, resolve target assets, inspect results, reserve an
output root, or invoke the reviewed physical adapter.
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="CDM-D V6 matched-score static dry plan")
    ...
    _bootstrap()
    from src.causal_dual_memory_cell_d_score_v6 import plan
