#!/usr/bin/env python3
"""Static public dry entry point for the CDM-D V8 matched-score successor."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="CDM-D V8 matched-score static dry plan")
    ...
    _bootstrap()
    from src.causal_dual_memory_cell_d_score_v8 import plan
