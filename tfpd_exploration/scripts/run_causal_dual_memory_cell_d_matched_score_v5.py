#!/usr/bin/env python3
"""Static public dry entry point for the V5-bound CDM-D matched score.

Flags alone are intentionally insufficient: this CLI never imports Torch,
opens data/results, creates an output root, or manufactures a root-reviewed
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="CDM-D V5 matched-score static dry plan")
    ...
    _bootstrap()
    from src.causal_dual_memory_cell_d_score_v5 import plan
