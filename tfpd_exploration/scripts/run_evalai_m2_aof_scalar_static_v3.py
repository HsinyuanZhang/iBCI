"""Inert AOF-S V3 local-build entrypoint; it cannot issue a capability."""
from __future__ import annotations
import argparse

def main() -> int:
    parser = argparse.ArgumentParser(description="AOF-S V3 local build is READY_REQUIRES_OPAQUE_CAPABILITY.")
