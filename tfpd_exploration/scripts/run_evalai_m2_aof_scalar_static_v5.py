"""Inert AOF-S V5 local-build entrypoint; it cannot issue a capability."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="AOF-S V5 local build is READY_REQUIRES_OPAQUE_CAPABILITY.")
