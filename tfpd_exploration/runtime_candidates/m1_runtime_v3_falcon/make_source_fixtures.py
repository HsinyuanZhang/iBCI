...
PACKAGE=ROOT/'submissions/evalai_m1_optimized_v2_t_e6_v1'
...
def main():
 ...
 rec=json.loads((PACKAGE/'artifacts/payload.receipt.json').read_text()); names=['ses-20120926','ses-20120927','ses-20120928','ses-20120926'];stems=[Path(rec['banks']['records'][n]['file']).stem for n in names]
 ...
 spec=importlib.util.spec_from_file_location('_frozen_m1_pkg',PACKAGE/'m1_trf_falcon_decoder.py');mod=importlib.util.module_from_spec(spec);sys.modules[spec.name]=mod;spec.loader.exec_module(mod)
